 ...
 * {@link ClassifyRequestConsumer} consumes it and runs the classifier, and the result lands in
 * {@link TicketStatusStore} for the GET endpoint to read. {@link ClassifierAgent} is mocked — this
 * test is about the Kafka plumbing, not re-verifying classification logic already covered by
 * {@code ClassifierAgentTest}.
 */
@Testcontainers
@SpringBootTest(
...
class TriageKafkaIntegrationTest {
    ...
    @Test
    void ticketFlowsThroughKafkaFromSubmissionToClassifiedStatus() throws InterruptedException {
